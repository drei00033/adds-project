...
public class RoomOrderTable extends JPanel {
    ...
    public RoomOrderTable() {
        ...
        JLabel headerLabel = new JLabel("Room Order Records", SwingConstants.CENTER);
        ...
        // Table setup
        String[] columnNames = { "Room ID", "RoomNo", "ReservationNo" };
        String[][] data = fetchRoomOrderData();
    ...
    private String[][] fetchRoomOrderData() {
        ...
        try {
            ...
            ResultSet rs = stmt.executeQuery("SELECT * FROM ROOM_ORDER");
